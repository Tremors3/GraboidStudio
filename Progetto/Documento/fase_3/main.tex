...
\begin{longtable}{|p{.15\linewidth}|p{.25\linewidth}|p{.2\linewidth}|p{.2\linewidth}|}
    ...
    Studio & Uno studio consiste in due spazi: una Sala di Controllo e una Sala di Registrazione & & Tecnico \\ \hline
...
\begin{longtable}{|p{.15\linewidth}|p{.25\linewidth}|p{.2\linewidth}|p{.2\linewidth}|}
    ...
    Studio & Uno studio consiste in due spazi: una Sala di Controllo e una Sala di Registrazione & & Prenotazioni \\ \hline
\end{longtable}
\textbf{Tabella 1.\ctabelle} Dizionario dei concetti

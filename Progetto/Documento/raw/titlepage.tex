...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \textsc{Course Name}\\[0.5cm]
    \text{\large L-31}\\[2cm]
    
    {\Large \textbf{\textcolor{tudelftdarkblue}{Autori:}}}\\[0.5cm]
    \begin{tabular}{c}
        \Large \textcolor{tudelftdarkblue}{Menozzi Matteo} \\
        \Large \textcolor{tudelftdarkblue}{Patrini Andrea} \\
        \Large \textcolor{tudelftdarkblue}{Turci Sologni Enrico} \\
    \end{tabular}\\[2cm]
